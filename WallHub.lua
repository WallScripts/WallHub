...
local Window = OrionLib:MakeWindow({IntroText = "Wall Hub(beta)", IntroIcon = "rbxassetid://8834748103",Name = ("Wall Hub 1.3 | Scripts Aleatórios".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, InEnabled = true, ConfigFolder = "Wall Hub"})
...
Tab:AddParagraph("Funky Friday | Uni Hub","Não sei (discord: https://discord.gg/44PHnFKxq5)")
Tab:AddButton({
	Name = "Copiar Discord",
	Callback = function()copyToClipboard2("https://discord.gg/44PHnFKxq5")    
      		print("botão pressionado")
  	end
})
